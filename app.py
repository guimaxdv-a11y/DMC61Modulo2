...
modulo = st.sidebar.radio(
    ...
    ["🏠 Módulo 1: Home", "📂 Módulo 2: Carga de Datos", "📊 Módulo 3: EDA (Próximamente)"]
)
...
if modulo == "🏠 Módulo 1":
    ...
    st.markdown("---")
    st.info("👈 **Instrucción:** Dirígete al **Módulo 2: Carga de Datos** en la barra lateral para cargar tu archivo CSV y comenzar con la exploración.")
...
# ==========================================
    ...
    if uploaded_file is not None:
        ...
        # Guardamos el archivo en la sesión para usarlo en los siguientes módulos si se requiere
